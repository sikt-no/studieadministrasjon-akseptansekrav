...
Egenskap: 03 Opptak: 27 Svare på tilbud
...
Scenario: Søker kan endre svaret på tilbud på en søknad før frist

Scenario: Saksbehandler svarer på tilbud på vegne av søker
